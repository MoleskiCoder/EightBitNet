...
namespace MC6809.UnitTest
{
    ...
    public class SchwotzerCompareLoadTests
    {
        ...
        // 64 rows: all combinations of initialCC in {0x00,0x01,0x20,0x21} × A in {0x00..0x0F, plus selected values}
        // Data from Schwotzer TBDAA table, hardware-verified on EF6809P
        [DataTestMethod]
        // initialCC=0x00 (H=0, C=0)
        ...
        [DataRow(0x00, 0x19, 0x19, 0x00)]
        [DataRow(0x00, 0x1A, 0x20, 0x00)]
        [DataRow(0x00, 0x90, 0x90, 0x08)]
        [DataRow(0x00, 0x99, 0x99, 0x08)]
        [DataRow(0x00, 0x9A, 0x00, 0x05)]
        [DataRow(0x00, 0xA0, 0x00, 0x05)]
        [DataRow(0x00, 0xF9, 0x59, 0x01)]
        [DataRow(0x00, 0xFF, 0x65, 0x01)]
        // initialCC=0x01 (H=0, C=1)
        ...
        [DataRow(0x01, 0x19, 0x79, 0x01)]
        [DataRow(0x01, 0x1A, 0x80, 0x09)]
        [DataRow(0x01, 0x90, 0xF0, 0x09)]
        [DataRow(0x01, 0x99, 0xF9, 0x09)]
        [DataRow(0x01, 0x9A, 0x00, 0x05)]
        [DataRow(0x01, 0xA0, 0x00, 0x05)]
        [DataRow(0x01, 0xF9, 0x59, 0x01)]
        [DataRow(0x01, 0xFF, 0x65, 0x01)]
        // initialCC=0x20 (H=1, C=0)
        ...
        [DataRow(0x20, 0x19, 0x1F, 0x00)]
        [DataRow(0x20, 0x1A, 0x20, 0x00)]
        [DataRow(0x20, 0x90, 0x96, 0x08)]
        [DataRow(0x20, 0x99, 0x9F, 0x08)]
        [DataRow(0x20, 0x9A, 0x00, 0x05)]
        [DataRow(0x20, 0xA0, 0x06, 0x01)]
        [DataRow(0x20, 0xF9, 0x5F, 0x01)]
        [DataRow(0x20, 0xFF, 0x65, 0x01)]
        // initialCC=0x21 (H=1, C=1)
        ...
        [DataRow(0x21, 0x19, 0x7F, 0x01)]
        [DataRow(0x21, 0x1A, 0x80, 0x09)]
        [DataRow(0x21, 0x90, 0xF6, 0x09)]
        [DataRow(0x21, 0x99, 0xFF, 0x09)]
        [DataRow(0x21, 0x9A, 0x00, 0x05)]
        [DataRow(0x21, 0xA0, 0x06, 0x01)]
        [DataRow(0x21, 0xF9, 0x5F, 0x01)]
