...
namespace EightBit
{
    public class M6502Core(Bus bus) : LittleEndianProcessor(bus)
    {
        ...
        protected void Swallow() => this.MemoryRead(this.PC.Word);

        protected void SwallowStack() => this.MemoryRead(this.S, 1);
        ...
        protected virtual bool MaybeExecute()
        {
            ...
            switch (this.OpCode)
            {
                ...
                case 0x1e: this.AbsoluteXAddress(); this.FixupR(); this.ModifyWrite(this.ASL()); break;                 // ASL (absolute, X)
                ...
                case 0x3e: this.AbsoluteXAddress(); this.FixupR(); this.ModifyWrite(this.ROL()); break;                 // ROL (absolute, X)
                ...
                case 0x5e: this.AbsoluteXAddress(); this.FixupR(); this.ModifyWrite(this.LSR()); break;                 // LSR (absolute, X)
                ...
                case 0x7e: this.AbsoluteXAddress(); this.FixupR(); this.ModifyWrite(this.ROR()); break;	                // ROR (absolute, X)
                ...
                case 0xde: this.AbsoluteXAddress(); this.FixupR(); this.ModifyWrite(this.DEC()); break;                 // DEC (absolute, X)
                ...
                case 0xfe: this.AbsoluteXAddress(); this.FixupR(); this.ModifyWrite(this.INC()); break;                 // INC (absolute, X)
            }
        ...
        protected void MaybeFixupR()
        {
            this.MaybeFixup();
            this.MemoryRead();
        }

        protected void FixupR()
        {
            this.Fixup();
            this.MemoryRead();
        }
